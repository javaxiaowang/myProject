...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#insertclient").click(function(){
			...
			window.location.href="downLoadBee?id="+company;
			//var uploadType = 1;
			/* if(uploadType==8){
			 $.ajax({
					url:"downLoadBee",
				...
				url:"listCompany",
		      	...
		      	success:function(data){
		      		 ...
		      		 for(var i=0 ;i<=lenth;i++){
		      			$("#company").append("<option value='"+ data.data[i].id+"'>"+ data.data[i].company +"</option>");
		      			}
		      		 /* $.each( data,function(){
  ...
  <div class="form-group">
	...
	<div class="panel"
		...
		<div class="panel-heading">
			<h3 class="panel-title">下载客户数据</h3>
		</div>
		<div class="panel-body">
			...
			<form method="POST" enctype="multipart/form-data" id="form1"
				...
				<input class="btn btn-primary" style="width:400px;margin-top: 20px" type="button" value="提交" id="insertclient" name="btn">
			</form>
		</div>
	</div>
			<!-- 展示导入数据 -->
