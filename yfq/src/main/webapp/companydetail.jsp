								...
								<div class="panel-body" style="margin-top: 20px;">
									...
									<!--  <div id="div1" >  
									    ...
									    <div class="big_pic">
									        ...
									        <img src="img/yifenqis.png"  width="2000" height="2000"/>            
									    </div>
									</div> -->
								 <%-- <div id="div1">  
								    <div class="small_pic">
								        ...
								        <span class="float_layer"></span>
								        <!--在img的src里改为你自己的图片的路径-->
								        <img class="pforimg" src="${data.licenseImg}"/>      
								    </div>
								    <div class="big_pic">
								        <!--在这里的width，height可以调整放大倍数-->
								        <img src="${data.licenseImg}"  width="900" height="900"/>         
								    </div>
								</div>
								 <div id="div2">  
								    <div class="small_pic1">
								        ...
								        <!--在img的src里改为你自己的图片的路径-->
								        <img class="pforimg1" src="${data.contract}"/>      
								    </div>
								    <div class="big_pic1">
								        <!--在这里的width，height可以调整放大倍数-->
								        <img src="${data.contract}"  width="900" height="900"/>         
								    </div>
								</div>  --%>
								    <img id ="target1" style="width: 600px;height: 600px;margin-left:9%" alt="" src="${data.licenseImg}">            
									 <img id ="target2" style="width: 600px;height: 600px;margin-left: 1%;margin-right: 10%" alt="" src="${data.contract}"> 
							
							<div style="margin-left: 37%">
								<a href=”#” onClick="javascript :history.back(-1);"  class="btn btn-primary btn-xs" style="background-color:#449d44; border:1px solid #398439;width: 300px;margin-top: 1%">返回</a>
							</div>
							<!-- END BASIC TABLE -->
						</div>
					</div>
