                    	...
                    	if(data!=null){
						    ...
						    $.ajax({
									url:"updateCompany",
							      	...
							      	async:true,
							      	dataType:"json",
							      	data: {id:companyid,company:company,companyCode:companyCode,address:address,linkMan:linkMan,phone:phone,email:email,licenseImg:licenseImg,contract:contract},
							      	success:function(data){
							      	if(data.data===1){
							      		$("#msg").html("新增成功");
  ...
  <!--表单  -->
	 <div class="panel" style="width: 800px;height:600px;margin-left: 100px;margin-top: 10px">
		...
		<div class="panel-body" >
			...
			<input id="companyid" value="${data.id}"  type="hidden">
				<div style="float:left"><label style="float: left;width: 80px;line-height: 34px">公司名称</label></div>
				<input id="company" value="${data.company}"  type="text" required="required" class="form-control" placeholder="公司名称" name="username" style="display: block;width: 50%">
				...
				<input id="companyCode" value="${data.companyCode}" type="text" required="required" class="form-control" placeholder="公司统一社会信用代码" name="password" style="display: block;width: 50%"> 
				...
				<input id="address" value="${data.address}" type="text" class="form-control" placeholder="公司地址" style="display: block;width: 50%"> 
				...
				<input id="linkMan" value="${data.linkMan}" type="text" required="required" class="form-control"placeholder="联系人" name="recomCode" style="display: block;width: 50%">
				...
				<!-- <br> 
				 ...
				 <input id="phone" value="${data.phone}" type="text" required="required" class="form-control" placeholder="联系电话" style="display: block;width: 50%">
				<div style="float:left"><label id="phoneCheck" style="line-height: 34px;color: red"></label></div>
				 ...
				 <input id="email" value="${data.email}" type="email"  required="required"  pattern="" class="form-control" placeholder="邮箱" style="display: block;width: 50%">
				...
				<div style="float:left"><label id="conCheck" style="line-height: 34px;color: red"></label></div>
				 ...
				 <br>
				 <br>
				<button id="submit" type="button" class="btn btn-primary" style="width: 400px;margin-left: 30px">修改</button><span id="msg" style="color:green;"></span>
