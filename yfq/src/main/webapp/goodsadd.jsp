	...
	$(function(){
		 	$.ajax({
				url:"attributeAndValue",
		      	...
		      	data: JSON.stringify({attribute:"存储容量"}),
		    ...
		    $.ajax({
				url:"attributeAndValue",
		      	...
		      	dataType:"json",
		      	contentType: "application/json",
		      	data: JSON.stringify({attribute:"版本"}),
		      	success:function(data){
		      		 var lenth = data.data.length;
		      		 for(var i=0 ;i<=lenth;i++){
	 ...
	 <div class="panel" style="width: 800px;height:600px;margin-left: 100px;margin-top: 10px">
		...
		<div class="panel-body" >
			<form action="userInsertAndUpdate" method="post">
				 <label style="float: left;width: 80px;line-height: 34px">商品名称</label>
				 <input id="goodsname" type="text" required="required" class="form-control" placeholder="商品名称" style="display: block;width: 50%">
				 <span id="goodsnamemsg" style="color:red;"></span>
				 <br>
				 <br>
				 <br>
				<div style="float:left"><label style="float: left;width: 85px;line-height: 34px">品牌</label></div>
				<select id="brand" class="form-control"style="width: 374px" name="userType" style="display: block;width: 50%">
				...
				<br>
				<br>
				<label style="float: left;width: 80px ;line-height: 34px">型号</label>
				<!-- <select id="model" class="form-control"style="width: 150px" name="userType" style="display: block;width: 50%">
				 ...
				 <input id="model" type="text" required="required" class="form-control" placeholder="型号"name="password" style="display: block;width: 50%"> 
				 
				<br>
				<br>
				<br>
				<label style="float: left;width: 80px;line-height: 34px">颜色</label>
				<!-- <select id="color" class="form-control"style="width: 150px" name="userType" style="display: block;width: 50%">
					<option value="1" selected="selected">品牌</option>
				</select> -->
				 <input id="color" type="text" required="required" class="form-control" placeholder="颜色" style="display: block;width: 50%"> 
				 <br> 
				 <br>
				 <br>
				<label style="float: left;width: 85px;line-height: 34px">存储容量</label>
				<select id="memory" class="form-control"style="width: 374px" name="userType" style="display: block;width: 50%">
					<!-- <option value="1" selected="selected">品牌</option> -->
				</select>
				 <br> 
				 <label style="float: left;width: 85px;line-height: 34px">版本</label>
				...
				<select id="supplier" class="form-control"style="width: 374px" name="userType" style="display: block;width: 100%">
				 ...
				 <br> 
				 <label style="float: left;width: 80px;line-height: 34px">价格</label>
				 <input id="price" type="text"  required="required" class="form-control" placeholder="价格" style="display: block;width: 50%">
				 <br> 
				 <br> 
				 <br> 
				 <label style="float: left;width: 80px;line-height: 34px">选择图片</label>
				 ...
				 <br> 
				 <br> 
				<button id="submit" type="button" class="btn btn-info" style="width: 200px;">保存商品信息</button>
