...
<script type="text/javascript">
	$(function(){
		 $("#submit").click(function(){
			...
			if(password!=""&&username!=""&&phone!=""&&company!=""){
			if(password==dpassword){
				    ...
				    $.ajax({
							url:"userInsertAndUpdate",
					      	...
					      	async:true,
					      	dataType:"json",
					      	data: {username:username,password:password,phone:phone,recomCode:recomCode,officephone:officephone,usertype:usertype,company:company,type:1},
	 ...
	 <div class="panel" style="width: 800px;height:600px;margin-left: 100px;margin-top: 10px">
		...
		<div class="panel-body" >
			<form action="userInsertAndUpdate" method="post">
				...
				<input id="username"  type="text" required="required" class="form-control" placeholder="用户名" name="username" style="display: block;width: 50%">
				...
				<input id="password" type="password" required="required" class="form-control" placeholder="密码"name="password" style="display: block;width: 50%"> 
				...
				<input id="dpassword" type="password" class="form-control" placeholder="确认密码" style="display: block;width: 50%"> 
				...
				<br> 
				 ...
				 <input id="phone" type="number" required="required" class="form-control" placeholder="联系电话" style="display: block;width: 50%">
				...
				<br> -->
				 ...
				 <input id="company" type="text"  required="required"  pattern="" class="form-control" placeholder="所属公司" style="display: block;width: 50%">
				<div style="float:left"><label id="companyCheck" style="line-height: 34px;color: red"></label></div>
				<br> 
				<br> 
				<label style="float: left;width: 85px;line-height: 34px">用户类型</label>
				<select id="select" class="form-control"style="width: 374px" name="userType" style="display: block;width: 50%">
					<option value="1">系统管理员</option>
					<option value="2">客服</option>
				</select>
				<br>
				<button id="submit" type="button" class="btn btn-primary" style="width: 400px;margin-left: 30px">新增</button>
